        ...
        <div class="col-md-4">
               ...
               <div class="card">
                   <form action="{{Route('searchJobs')}}" method="post">
                    ...
                    <div class="card-body">
                        <input type="text" name="JobTitle" placeholder="Key skill, Title, job role" class="form-control">
                        <br/>
                        <input type="text" name="Location" placeholder="Location, City, State"  class="form-control">
                    </div>
