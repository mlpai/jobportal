            ...
            <div class="card">
                <div class="card-header">
                        <h4 class="card-title text-bold ">
                                Profile Summary
                                <a class="link" href="{{Route('profile.edit',$jobseeker->id)}}" style="float:right;"><span class="fas red-ico fa-pencil-alt"></span></a>
                            </h4>
                </div>
                <div class="card-body">
                                    ...
                                    @if($jobseeker->jobseekerExperience->where('currently_working',1)->first() != null)
                                        <td>
                                            @foreach($jobseeker->jobseekerExperience->where('currently_working',1) as $job)
                                                ...
                                                <a href="{{route('Experiences.edit',$job->id)}}" ><span class="fas fa-pencil-alt blue-ico float-right mr-4"></span></a>
                                                <br/>
